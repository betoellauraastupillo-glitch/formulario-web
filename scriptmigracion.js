document.getElementById("formulario").addEventListener("submit", function (event) {
  ...
  let resumen = "📋 RESUMEN DE LA MIGRACIÓN\n\n";
...
document.getElementById("agregar-equipo").addEventListener("click", () => {
  ...
  // Eliminar equipo
  div.querySelector(".eliminar-equipo").addEventListener("click", () => div.remove());
});
...
document.getElementById("agregar-equipo-retirado").addEventListener("click", () => {
  ...
  div.querySelector(".eliminar-equipo-retirado").addEventListener("click", () => div.remove());
});
